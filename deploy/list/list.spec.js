...
testing_1.describe('MdList', function () {
    ...
    testing_1.it('should add and remove focus class on focus/blur', function () {
        ...
        return builder.overrideTemplate(TestList, template)
            ...
            testing_1.expect(listItemDiv.nativeElement.classList).not.toContain('md-list-item-focus');
            listItem.componentInstance.handleFocus();
            fixture.detectChanges();
            testing_1.expect(listItemDiv.nativeElement.classList).toContain('md-list-item-focus');
...
//# sourceMappingURL=C:/code/Awesomeweb/material2/tmp/broccoli_type_script_compiler-input_base_path-PUdNP9c8.tmp/0/components/list/list.spec.js.map